...
\centerline{
  \includegraphics[width=0.2\textwidth]{head.jpg}
}
...
\subsubsection{问题总结} 
1. 使用OpenWrt系统的过程中，当没有配置网口的通信方式时，直接插网口会导致一开始配置的网口出现问题
2. 负载均衡中的源地址和目的地址理解性错误，源地址统指客户端即本地的pc端，目的地址为客户端要到达的地址
3. 无法访问实验室服务器问题，在静态路由中添加路由表解决。
4. DDNS配置问题，可以查看文件

\href{run:./other_guide/openwrt_set_DDNS.pdf}{DDNS}
